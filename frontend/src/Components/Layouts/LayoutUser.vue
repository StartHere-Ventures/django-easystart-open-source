...
export default {
  ...
  setup(props) {
    const defaultNavigation = [
      { name: 'Home', href: 'core:index', icon: HomeIcon, current: props.navActive == "home" ? true : false },
    ]
    const secondaryNavigation = [
      { name: 'Help', href: 'core:index', icon: QuestionMarkCircleIcon, current: false },
      { name: 'Account Settings', href: 'core:settings', icon: CogIcon, current: props.navActive == "settings" ? true : false },
      { name: 'Logout', href: 'accounts:logout', icon: LogoutIcon, current: false },
    ]
