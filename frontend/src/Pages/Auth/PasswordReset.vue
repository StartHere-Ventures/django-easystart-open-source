      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div class="mt-8">
          <p class="text-gray-600 leading-relaxed">
            {{ $_("Have you forgotten your password? Enter your email and we will send you an email that will allow you to reset it.") }}
          </p>
          <div class="pt-4">
            <form
              class="space-y-4"
...
export default {
  ...
  methods: {
    ...
    onSubmit(event) {
      ...
      this.$inertia.post(this.route('accounts:reset_password'), this.form, {
